...
export function ShareButtons({ title, slug }: ShareButtonsProps) {
  ...
  return (
    <div className="flex items-center gap-2 flex-wrap">
      <span className="text-xs text-[#9CA3AF] font-medium uppercase tracking-wider">Share:</span>
      <a href={twitterUrl} target="_blank" rel="noopener noreferrer" aria-label="Share on X/Twitter"
        className="flex items-center gap-1.5 px-3 py-1.5 bg-white/5 hover:bg-[#00D4FF]/10 border border-white/10 hover:border-[#00D4FF]/30 rounded-full text-xs text-[#9CA3AF] hover:text-[#00D4FF] transition-all duration-200">
